public class KratisiEisitiriwn extends javax.swing.JFrame {

     private ReservationInterface service;
    
    public KratisiEisitiriwn(ReservationInterface service) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Κράτηση Εισιτηρίων");
        ...
        jLabel8.setText("Αριθμός Εισητηρίων:");

        jLabel9.setText("Συνολική Τιμή:");
